...
set "APP_CLASSPATH=%APP_LIB_DIR%\co.zerus.katana.katana-0.1-SNAPSHOT.jar;%APP_LIB_DIR%\org.scala-lang.scala-library-2.10.3.jar;%APP_LIB_DIR%\com.github.scopt.scopt_2.10-3.2.0.jar;%APP_LIB_DIR%\com.google.guava.guava-16.0.1.jar;%APP_LIB_DIR%\org.redline-rpm.redline-1.1.15.jar;%APP_LIB_DIR%\org.apache.ant.ant-1.9.1.jar;%APP_LIB_DIR%\org.apache.ant.ant-launcher-1.9.1.jar;%APP_LIB_DIR%\org.slf4j.slf4j-log4j12-1.7.5.jar;%APP_LIB_DIR%\org.slf4j.slf4j-api-1.7.5.jar;%APP_LIB_DIR%\log4j.log4j-1.2.17.jar;%APP_LIB_DIR%\org.apache.commons.commons-compress-1.6.jar;%APP_LIB_DIR%\org.tukaani.xz-1.4.jar;%APP_LIB_DIR%\org.bouncycastle.bcpg-jdk15on-1.50.jar;%APP_LIB_DIR%\org.bouncycastle.bcprov-jdk15on-1.50.jar;%APP_LIB_DIR%\com.twitter.util-eval_2.10-6.13.0.jar;%APP_LIB_DIR%\com.twitter.util-core_2.10-6.13.0.jar;%APP_LIB_DIR%\org.scala-lang.scala-compiler-2.10.3.jar;%APP_LIB_DIR%\org.scala-lang.scala-reflect-2.10.3.jar"
